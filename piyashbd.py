...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://m.me/ummmmaaah.janu"])
	exit(" [*] FACEBOOK :  https://https://www.facebook.com/ummmmaaah.janu")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> PIYASH SARDAR")
	subprocess.check_output(["am", "start", "https://wa.me/+8801873615592"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/piyash12345/past/blob/main/a.txt').text
			if basesplit in plr:
				key = basesplit
 ...
 ┌──────────────────────────────────────────────────────┐
 │[✓] DEVOLPER   :            PIYASH SARDAR          
 │[✓] FACEBOOK   :            PIYASH SARDAR              
 │[✓] WHATSAPP   :            +8801873615592           
 │[✓] GITHUB     :            Piyash Fucker                   
 │[✓] TOOLS      :            PIYASH-JUST-NOW-UID  \033[1;31mV=4.0.1  \033[1;32m
 \033[1;32m────────────────────────────────────────────────────────┘
"""        )
...
"""        )
 ...
 │[✓] DEVOLPER   :            PIYASH SARDAR      │
 │[✓] FACEBOOK   :            PIYASH SARDAR     │
 │[✓] WHATSAPP   :            +88018615592        │
 │[✓] GITHUB     :            Piyash-FUCKER          │
 │[✓] TOOLS      :            JUST-NOW-UID   \033[1;31mV=4.0.1    \033[1;32m│
 \033[1;32m└──────────────────────────────────────────────────────┘
"""        )
				for user in self.id:
